function createVideoPC_sbu(command_str,position)
% Function for creating the SBU according to the Video PC standard.
...
if strcmp(command_str,'initialize')
    ...
    h_fig = findobj(h_figs,'flat', 'tag','createVideoACR_sbu');
    if ~isempty(h_fig)
        figure(h_fig(1));
        return
    end
    ...
    h_fig = figure('position',position,...
        'name','Create Video ACR sbu', ...
        'tag','createVideoACR_sbu');
    ...
    uicontrol(monitors_panel,...
        'Style','popupmenu',...
        'units', 'normalized',  ...
        'String',{'Select content for left monitor...',...
        'Stimulus 1',...
        'Stimulus 2',...
        'Both stimuli',...
        'Questions',...
    ...
    uicontrol(monitors_panel,...
        'Style','popupmenu',...
        'units', 'normalized', ...
        'String',{'Select content for center monitor...',...
        'Stimulus 1',...
        'Stimulus 2',...
        'Both stimuli',...
        'Questions',...
    ...
    uicontrol(monitors_panel,...
        'Style','popupmenu',...
        'units', 'normalized', ...
        'String',{'Select content for right monitor...',...
        'Stimulus 1',...
        'Stimulus 2',...
        'Both stimuli',...
        'Questions',...
    ...
    uicontrol(monitors_panel,...
        'Style','popupmenu',...
        'units', 'normalized', ...
        'String',{'Select content for bottom monitor...',...
        'Stimulus 1',...
        'Stimulus 2',...
        'Both stimuli',...
        'Questions',...
