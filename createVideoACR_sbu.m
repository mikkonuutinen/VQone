function createVideoACR_sbu(command_str,position)

global standard name setup_file_path modifying first_time version setup
...
if ~strcmp(command_str,'initialize')
    ...
    h_fig = gcf;
    if ~strcmp(get(h_fig,'tag'),'createVideoACR_sbu')
...
if strcmp(command_str,'initialize')
    ...
    uicontrol(randomizing_panel,...
        ...
        'String','Enable referencing', ...
        'callback',@enable_referencing,...
        'FontSize', 12);
    
    uicontrol(randomizing_panel,...
        'Style','text', ...
        'Units','normalized',...
        'Position',[0.01 0.15 0.99 0.2], ...
        'String','', ...
        'FontSize', 12,...
        'tag','ref_help_text',...
        'HorizontalAlignment','left');
...
function enable_referencing(source,~)
global setup
setup.referencing_enabled = get(source,'value');
if setup.referencing_enabled
    disp('Referencing enabled');
    set(findobj(gcf,'tag','ref_help_text'),...
        'string','Show one good and one bad reference video for each content. Remember to define the reference videos in the filelist.')
else
    disp('Referencing disabled');
    set(findobj(gcf,'tag','ref_help_text'),...
        'string','')
end
...
setup.sequences = createVideoACRRandomization(setup);
...
if strcmp(type,'left_monitor') == 1
    switch str{val};
        ...
        case 'References'
            setup.left_monitor = 'References';
            setup.stimuli_in_one_monitor = 0;
        case 'Stimulus & References'
            setup.left_monitor = 'Stimulus & References';
...
elseif strcmp(type,'center_monitor') == 1
    switch str{val};
        case 'Stimulus'
            ...
            setup.stimuli_in_one_monitor = 0;
        case 'References'
            setup.center_monitor = 'References';
            setup.stimuli_in_one_monitor = 0;
        case 'Stimulus & References'
            setup.center_monitor = 'Stimulus & References';
            setup.stimuli_in_one_monitor = 1;
        case 'Disabled'
...
elseif strcmp(type,'right_monitor') == 1
    switch str{val};
        case 'Stimulus'
            ...
            setup.stimuli_in_one_monitor = 0;
        case 'References'
            setup.right_monitor = 'References';
            setup.stimuli_in_one_monitor = 0;
        case 'Stimulus & References'
            setup.right_monitor = 'Stimulus & References';
            setup.stimuli_in_one_monitor = 1;
        case 'Disabled'
    ...
    switch str{val};
        ...
        case 'References'
            setup.bottom_monitor = 'References';
        case 'Disabled'
...
if setup.modifying == 0
    ...
    if isempty(setup.referencing_enabled)
    ...
    if strcmp(setup.left_monitor,'Stimulus') == 0 && ...
        ...
        if strcmp(setup.left_monitor,'Stimulus & References') == 0 && ...
                strcmp(setup.right_monitor,'Stimulus & References') == 0 && ...
                strcmp(setup.center_monitor,'Stimulus & References') == 0
