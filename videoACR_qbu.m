function videoACR_qbu(command_str,position,file_path)
...
if strcmp(command_str,'initialize')
    ...
    % TODO: Initialize current_values for every component in the gui
