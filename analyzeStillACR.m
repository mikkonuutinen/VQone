...
% Function that analyzes the subject input data (still ACR) and shows
...
imageFile_column_nr=find(strcmp(text(1,:),'image_file'),1);
...
file_vector(:,1)=text_sorted(:,imageFile_column_nr);
