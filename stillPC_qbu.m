function stillPC_qbu(command_str,position,file_path)
% Function for showing the question screen after the stimuli in Still/Video PC.
% Global variable needed:
%   current_data  -variable for storing the current trial's subject input.
